...
MODEL_NAME = "CohereLabs/aya-expanse-8b"  # Change this if needed
...
training_arguments = TrainingArguments(
    output_dir="/scratch/09790/rpant23/urdu_generation",
    num_train_epochs=25,
...
# For setting up the generation task, the SFTTrainer expects a Standard dataset format
# Refer to the HuggingFace documentation for structural details.
# Very similar to the dataset structure requested by Apple MLX.
trainer = SFTTrainer(
    model=model,
    train_dataset=dataset,
    eval_dataset=val_dataset,
    peft_config=aya_peft_config,
    tokenizer=tokenizer,
...
save_path = f"/scratch/09790/rpant23/urdu_generation/{MODEL_NAME}_urdu_adapter"
